...
import static com.bumptech.glide4110.load.ImageHeaderParser.ImageType.GIF;
import static com.bumptech.glide4110.load.ImageHeaderParser.ImageType.JPEG;
import static com.bumptech.glide4110.load.ImageHeaderParser.ImageType.PNG;
import static com.bumptech.glide4110.load.ImageHeaderParser.ImageType.PNG_A;
import static com.bumptech.glide4110.load.ImageHeaderParser.ImageType.UNKNOWN;
...
public final class DefaultImageHeaderParser implements ImageHeaderParser {
  ...
  public ImageType getType(@NonNull InputStream is) throws IOException {
    return getType(new StreamReader(com.bumptech.glide4110.util.Preconditions.checkNotNull(is)));
  }

  @NonNull
  @Override
  public ImageType getType(@NonNull ByteBuffer byteBuffer) throws IOException {
    return getType(new ByteBufferReader(com.bumptech.glide4110.util.Preconditions.checkNotNull(byteBuffer)));
  }

  @Override
  public int getOrientation(@NonNull InputStream is, @NonNull com.bumptech.glide4110.load.engine.bitmap_recycle.ArrayPool byteArrayPool)
      throws IOException {
    return getOrientation(
        new StreamReader(com.bumptech.glide4110.util.Preconditions.checkNotNull(is)),
        com.bumptech.glide4110.util.Preconditions.checkNotNull(byteArrayPool));
  }

  @Override
  public int getOrientation(@NonNull ByteBuffer byteBuffer, @NonNull com.bumptech.glide4110.load.engine.bitmap_recycle.ArrayPool byteArrayPool)
      throws IOException {
    return getOrientation(
        new ByteBufferReader(com.bumptech.glide4110.util.Preconditions.checkNotNull(byteBuffer)),
