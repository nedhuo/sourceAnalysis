...
public class GifDrawable extends Drawable
   ...
   *     of the view or {@link Target} this drawable is being
   *     loaded into).
   * @param targetFrameHeight The desired height of the frames displayed by this drawable (the
   *     height of the view or {@link Target} this drawable is
   *     being loaded into).
  ...
  GifDrawable(GifState state) {
    this.state = com.bumptech.glide4110.util.Preconditions.checkNotNull(state);
  }
  ...
  public void startFromFirstFrame() {
    com.bumptech.glide4110.util.Preconditions.checkArgument(!isRunning, "You cannot restart a currently running animation.");
