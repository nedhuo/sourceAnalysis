...
public class ByteBufferGifDecoder implements ResourceDecoder<ByteBuffer, GifDrawable> {
  ...
  private final com.bumptech.glide4110.load.resource.gif.GifBitmapProvider provider;
  ...
  public ByteBufferGifDecoder(Context context) {
    this(
        context,
        com.bumptech.glide4110.Glide.get(context).getRegistry().getImageHeaderParsers(),
        com.bumptech.glide4110.Glide.get(context).getBitmapPool(),
  ...
  public ByteBufferGifDecoder(
      ...
      com.bumptech.glide4110.load.engine.bitmap_recycle.ArrayPool arrayPool) {
  ...
  @Override
  public com.bumptech.glide4110.load.resource.gif.GifDrawableResource decode(
  ...
  @Nullable
  private com.bumptech.glide4110.load.resource.gif.GifDrawableResource decode(
