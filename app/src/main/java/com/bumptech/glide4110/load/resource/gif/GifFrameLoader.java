...
import com.bumptech.glide4110.request.target.CustomTarget;
import com.bumptech.glide4110.request.transition.Transition;
...
class GifFrameLoader {
  ...
  final com.bumptech.glide4110.RequestManager requestManager;
  ...
  private com.bumptech.glide4110.RequestBuilder<Bitmap> requestBuilder;
  ...
  GifFrameLoader(
      com.bumptech.glide4110.Glide glide,
    ...
    this(
        glide.getBitmapPool(),
        com.bumptech.glide4110.Glide.with(glide.getContext()),
        gifDecoder,
        null /*handler*/,
  ...
  GifFrameLoader(
      ...
      com.bumptech.glide4110.RequestManager requestManager,
      GifDecoder gifDecoder,
      Handler handler,
      com.bumptech.glide4110.RequestBuilder<Bitmap> requestBuilder,
      Transformation<Bitmap> transformation,
      Bitmap firstFrame) {
  ...
  void setFrameTransformation(Transformation<Bitmap> transformation, Bitmap firstFrame) {
    this.transformation = com.bumptech.glide4110.util.Preconditions.checkNotNull(transformation);
    this.firstFrame = com.bumptech.glide4110.util.Preconditions.checkNotNull(firstFrame);
    requestBuilder = requestBuilder.apply(new com.bumptech.glide4110.request.RequestOptions().transform(transformation));
  ...
  private void loadNextFrame() {
    ...
    if (startFromFirstFrame) {
      com.bumptech.glide4110.util.Preconditions.checkArgument(
    ...
    requestBuilder.apply(com.bumptech.glide4110.request.RequestOptions.signatureOf(getFrameSignature())).load(gifDecoder).into(next);
  }
  ...
  private static RequestBuilder<Bitmap> getRequestBuilder(
    ...
    return requestManager
        .asBitmap()
        .apply(
            com.bumptech.glide4110.request.RequestOptions.diskCacheStrategyOf(DiskCacheStrategy.NONE)
