...
import com.bumptech.glide4110.load.PreferredColorSpace;
import com.bumptech.glide4110.load.resource.bitmap.DownsampleStrategy.SampleSizeRounding;
...
public final class Downsampler {
  ...
  /**
   * Indicates the {@link com.bumptech.glide4110.load.resource.bitmap.DownsampleStrategy} option that
   ...
   *
   * @deprecated Use {@link com.bumptech.glide4110.load.resource.bitmap.DownsampleStrategy#OPTION} directly instead.
   */
  @Deprecated
  public static final Option<com.bumptech.glide4110.load.resource.bitmap.DownsampleStrategy> DOWNSAMPLE_STRATEGY = com.bumptech.glide4110.load.resource.bitmap.DownsampleStrategy.OPTION;
  /**
  ...
  private static final DecodeCallbacks EMPTY_CALLBACKS =
      new DecodeCallbacks() {
        ...
        @Override
        public void onDecodeComplete(com.bumptech.glide4110.load.engine.bitmap_recycle.BitmapPool bitmapPool, Bitmap downsampled) {
          // Do nothing.
        }
      };
  ...
  private final com.bumptech.glide4110.load.resource.bitmap.HardwareConfigState hardwareConfigState = HardwareConfigState.getInstance();

  public Downsampler(
      List<ImageHeaderParser> parsers,
      DisplayMetrics displayMetrics,
      com.bumptech.glide4110.load.engine.bitmap_recycle.BitmapPool bitmapPool,
      com.bumptech.glide4110.load.engine.bitmap_recycle.ArrayPool byteArrayPool) {
    this.parsers = parsers;
    this.displayMetrics = com.bumptech.glide4110.util.Preconditions.checkNotNull(displayMetrics);
    this.bitmapPool = com.bumptech.glide4110.util.Preconditions.checkNotNull(bitmapPool);
   ...
   * provided {@link com.bumptech.glide4110.load.resource.bitmap.DownsampleStrategy} option.
   *
   * @see #decode(InputStream, int, int, Options, DecodeCallbacks)
   */
  public com.bumptech.glide4110.load.engine.Resource<Bitmap> decode(InputStream is, int outWidth, int outHeight, Options options)
      throws IOException {
   ...
   * com.bumptech.glide4110.load.engine.bitmap_recycle.BitmapPool} whose dimensions exactly match those
  ...
  private Resource<Bitmap> decode(
    ...
    com.bumptech.glide4110.load.resource.bitmap.DownsampleStrategy downsampleStrategy = options.get(com.bumptech.glide4110.load.resource.bitmap.DownsampleStrategy.OPTION);
  ...
  private Bitmap decodeFromWrappedStreams(
      ...
      com.bumptech.glide4110.load.resource.bitmap.DownsampleStrategy downsampleStrategy,
    ...
    int degreesToRotate = com.bumptech.glide4110.load.resource.bitmap.TransformationUtils.getExifOrientationDegrees(orientation);
    boolean isExifOrientationRequired = com.bumptech.glide4110.load.resource.bitmap.TransformationUtils.isExifOrientationRequired(orientation);

    int targetWidth =
        requestedWidth == com.bumptech.glide4110.request.target.Target.SIZE_ORIGINAL
    ...
    if (downsampled != null) {
      ...
      rotated = com.bumptech.glide4110.load.resource.bitmap.TransformationUtils.rotateImageExif(bitmapPool, downsampled, orientation);
  ...
  private static Bitmap decodeStream(
    ...
    final Bitmap result;
    com.bumptech.glide4110.load.resource.bitmap.TransformationUtils.getBitmapDrawableLock().lock();
    try {
  ...
  private static void setInBitmap(
          BitmapFactory.Options options, com.bumptech.glide4110.load.engine.bitmap_recycle.BitmapPool bitmapPool, int width, int height) {
