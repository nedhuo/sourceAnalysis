...
public class ResourceLoader<Data> implements ModelLoader<Integer, Data> {
  ...
  public static class StreamFactory implements com.bumptech.glide4110.load.model.ModelLoaderFactory<Integer, InputStream> {
    ...
    @NonNull
    @Override
    public ModelLoader<Integer, InputStream> build(com.bumptech.glide4110.load.model.MultiModelLoaderFactory multiFactory) {
  ...
  public static class FileDescriptorFactory
      implements com.bumptech.glide4110.load.model.ModelLoaderFactory<Integer, ParcelFileDescriptor> {
    ...
    @NonNull
    @Override
    public ModelLoader<Integer, ParcelFileDescriptor> build(com.bumptech.glide4110.load.model.MultiModelLoaderFactory multiFactory) {
  ...
  public static final class AssetFileDescriptorFactory
      implements com.bumptech.glide4110.load.model.ModelLoaderFactory<Integer, AssetFileDescriptor> {
    ...
    @Override
    public ModelLoader<Integer, AssetFileDescriptor> build(com.bumptech.glide4110.load.model.MultiModelLoaderFactory multiFactory) {
      return new ResourceLoader<>(
