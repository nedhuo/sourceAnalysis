 ...
 * com.bumptech.glide4110.load.engine.DecodePath}s.
 *
 ...
 *     {@link com.bumptech.glide4110.load.engine.DecodePath}s.
...
public class LoadPath<Data, ResourceType, Transcode> {
  ...
  private final List<? extends com.bumptech.glide4110.load.engine.DecodePath<Data, ResourceType, Transcode>> decodePaths;
  ...
  public LoadPath(
      ...
      List<com.bumptech.glide4110.load.engine.DecodePath<Data, ResourceType, Transcode>> decodePaths,
      Pool<List<Throwable>> listPool) {
    this.dataClass = dataClass;
    this.listPool = listPool;
    this.decodePaths = com.bumptech.glide4110.util.Preconditions.checkNotEmpty(decodePaths);
    failureMessage =
        "Failed LoadPath{"
  ...
  public Resource<Transcode> load(
      com.bumptech.glide4110.load.data.DataRewinder<Data> rewinder,
      @NonNull Options options,
      int width,
      int height,
      com.bumptech.glide4110.load.engine.DecodePath.DecodeCallback<ResourceType> decodeCallback)
