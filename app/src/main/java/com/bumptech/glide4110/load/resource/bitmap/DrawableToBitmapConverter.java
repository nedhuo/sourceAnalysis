...
final class DrawableToBitmapConverter {
  ...
  private static final com.bumptech.glide4110.load.engine.bitmap_recycle.BitmapPool NO_RECYCLE_BITMAP_POOL =
  ...
  @Nullable
  static Resource<Bitmap> convert(com.bumptech.glide4110.load.engine.bitmap_recycle.BitmapPool bitmapPool, Drawable drawable, int width, int height) {
    ...
    com.bumptech.glide4110.load.engine.bitmap_recycle.BitmapPool toUse = isRecycleable ? bitmapPool : NO_RECYCLE_BITMAP_POOL;
  ...
  private static Bitmap drawToBitmap(
    ...
    if (width == com.bumptech.glide4110.request.target.Target.SIZE_ORIGINAL && drawable.getIntrinsicWidth() <= 0) {
