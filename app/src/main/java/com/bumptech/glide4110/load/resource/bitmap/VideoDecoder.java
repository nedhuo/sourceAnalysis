...
public class VideoDecoder<T> implements ResourceDecoder<T, Bitmap> {
  ...
  public static ResourceDecoder<AssetFileDescriptor, Bitmap> asset(com.bumptech.glide4110.load.engine.bitmap_recycle.BitmapPool bitmapPool) {
    return new VideoDecoder<>(bitmapPool, new AssetFileDescriptorInitializer());
  }

  public static ResourceDecoder<ParcelFileDescriptor, Bitmap> parcel(com.bumptech.glide4110.load.engine.bitmap_recycle.BitmapPool bitmapPool) {
    return new VideoDecoder<>(bitmapPool, new ParcelFileDescriptorInitializer());
  }

  @RequiresApi(api = VERSION_CODES.M)
  public static ResourceDecoder<ByteBuffer, Bitmap> byteBuffer(com.bumptech.glide4110.load.engine.bitmap_recycle.BitmapPool bitmapPool) {
    return new VideoDecoder<>(bitmapPool, new ByteBufferInitializer());
  }

  VideoDecoder(com.bumptech.glide4110.load.engine.bitmap_recycle.BitmapPool bitmapPool, MediaMetadataRetrieverInitializer<T> initializer) {
  ...
  public Resource<Bitmap> decode(
    ...
    if (downsampleStrategy == null) {
      downsampleStrategy = com.bumptech.glide4110.load.resource.bitmap.DownsampleStrategy.DEFAULT;
    }
  ...
  private static Bitmap decodeFrame(
      ...
      int outWidth,
      int outHeight,
      com.bumptech.glide4110.load.resource.bitmap.DownsampleStrategy strategy) {
    Bitmap result = null;
    ...
    if (Build.VERSION.SDK_INT >= VERSION_CODES.O_MR1
        && outWidth != com.bumptech.glide4110.request.target.Target.SIZE_ORIGINAL
        && outHeight != Target.SIZE_ORIGINAL
        && strategy != com.bumptech.glide4110.load.resource.bitmap.DownsampleStrategy.NONE) {
      result =
          decodeScaledFrame(
