...
public class ByteArrayLoader<Data> implements ModelLoader<byte[], Data> {
   ...
   * ByteBuffer}.
   */
  public static class ByteBufferFactory implements com.bumptech.glide4110.load.model.ModelLoaderFactory<byte[], ByteBuffer> {

    @NonNull
    @Override
    public ModelLoader<byte[], ByteBuffer> build(@NonNull com.bumptech.glide4110.load.model.MultiModelLoaderFactory multiFactory) {
