 ...
 */
public class StringLoader<Data> implements com.bumptech.glide4110.load.model.ModelLoader<String, Data> {
  private final com.bumptech.glide4110.load.model.ModelLoader<Uri, Data> uriLoader;

  // Public API.
  @SuppressWarnings("WeakerAccess")
  public StringLoader(com.bumptech.glide4110.load.model.ModelLoader<Uri, Data> uriLoader) {
  ...
  public static class StreamFactory implements com.bumptech.glide4110.load.model.ModelLoaderFactory<String, InputStream> {

    @NonNull
    @Override
    public com.bumptech.glide4110.load.model.ModelLoader<String, InputStream> build(@NonNull com.bumptech.glide4110.load.model.MultiModelLoaderFactory multiFactory) {
  ...
  public static class FileDescriptorFactory
      implements com.bumptech.glide4110.load.model.ModelLoaderFactory<String, ParcelFileDescriptor> {

    @NonNull
    @Override
    public com.bumptech.glide4110.load.model.ModelLoader<String, ParcelFileDescriptor> build(
        @NonNull com.bumptech.glide4110.load.model.MultiModelLoaderFactory multiFactory) {
