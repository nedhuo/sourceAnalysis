...
import com.bumptech.glide4110.load.data.FileDescriptorAssetPathFetcher;
import com.bumptech.glide4110.load.data.StreamAssetPathFetcher;
...
public class AssetUriLoader<Data> implements ModelLoader<Uri, Data> {
  ...
  /**
   * A factory to build a {@link com.bumptech.glide4110.load.data.DataFetcher} for a specific asset path.
   *
   * @param <Data> The type of data that will be obtained by the fetcher.
   */
  public interface AssetFetcherFactory<Data> {
    com.bumptech.glide4110.load.data.DataFetcher<Data> buildFetcher(AssetManager assetManager, String assetPath);
  }

  /** Factory for loading {@link InputStream}s from asset manager Uris. */
  public static class StreamFactory
      implements com.bumptech.glide4110.load.model.ModelLoaderFactory<Uri, InputStream>, AssetFetcherFactory<InputStream> {
    ...
    @NonNull
    @Override
    public ModelLoader<Uri, InputStream> build(com.bumptech.glide4110.load.model.MultiModelLoaderFactory multiFactory) {
    ...
    @Override
    public com.bumptech.glide4110.load.data.DataFetcher<InputStream> buildFetcher(AssetManager assetManager, String assetPath) {
