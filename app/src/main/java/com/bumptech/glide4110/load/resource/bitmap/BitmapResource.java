...
public class BitmapResource implements Resource<Bitmap>, Initializable {
   ...
   * @param bitmapPool A non-null {@link com.bumptech.glide4110.load.engine.bitmap_recycle.BitmapPool}.
   */
  @Nullable
  public static BitmapResource obtain(@Nullable Bitmap bitmap, @NonNull com.bumptech.glide4110.load.engine.bitmap_recycle.BitmapPool bitmapPool) {
    if (bitmap == null) {
      return null;
    } else {
  ...
  public BitmapResource(@NonNull Bitmap bitmap, @NonNull BitmapPool bitmapPool) {
    this.bitmap = com.bumptech.glide4110.util.Preconditions.checkNotNull(bitmap, "Bitmap must not be null");
