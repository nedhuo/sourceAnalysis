 ...
 * Transformation} either instead or in addition to a {@code
 * DownsampleStrategy}.
 *
 * <p>Some differences between versions of Android and {@link
 * ResourceDecoder}s are listed below, but the list is not comprehensive
 ...
 * is supported. To preserve the potential for a {@link Transformation} to
