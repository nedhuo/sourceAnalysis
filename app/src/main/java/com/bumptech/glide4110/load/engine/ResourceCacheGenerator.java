...
/**
 * Generates {@link com.bumptech.glide4110.load.data.DataFetcher DataFetchers} from cache files
 * containing downsampled/transformed resource data.
 */
class ResourceCacheGenerator implements com.bumptech.glide4110.load.engine.DataFetcherGenerator, DataFetcher.DataCallback<Object> {
  ...
  private com.bumptech.glide4110.load.Key sourceKey;
  private List<com.bumptech.glide4110.load.model.ModelLoader<File, ?>> modelLoaders;
  ...
  public boolean startNext() {
    List<com.bumptech.glide4110.load.Key> sourceIds = helper.getCacheKeys();
    ...
    while (!started && hasNextModelLoader()) {
      com.bumptech.glide4110.load.model.ModelLoader<File, ?> modelLoader = modelLoaders.get(modelLoaderIndex++);
      loadData =
