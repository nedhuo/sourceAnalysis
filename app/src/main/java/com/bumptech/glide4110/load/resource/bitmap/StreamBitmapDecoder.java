...
import com.bumptech.glide4110.util.ExceptionCatchingInputStream;
import com.bumptech.glide4110.util.MarkEnforcingInputStream;
...
public class StreamBitmapDecoder implements ResourceDecoder<InputStream, Bitmap> {
  ...
  public Resource<Bitmap> decode(
    ...
    final com.bumptech.glide4110.load.resource.bitmap.RecyclableBufferedInputStream bufferedStream;
    final boolean ownsBufferedStream;
    if (source instanceof com.bumptech.glide4110.load.resource.bitmap.RecyclableBufferedInputStream) {
      bufferedStream = (com.bumptech.glide4110.load.resource.bitmap.RecyclableBufferedInputStream) source;
      ownsBufferedStream = false;
    } else {
      bufferedStream = new com.bumptech.glide4110.load.resource.bitmap.RecyclableBufferedInputStream(source, byteArrayPool);
    ...
    com.bumptech.glide4110.util.ExceptionCatchingInputStream exceptionStream =
        com.bumptech.glide4110.util.ExceptionCatchingInputStream.obtain(bufferedStream);
    ...
    // buffer. See #283.
    com.bumptech.glide4110.util.MarkEnforcingInputStream invalidatingStream = new MarkEnforcingInputStream(exceptionStream);
  ...
  static class UntrustedCallbacks implements Downsampler.DecodeCallbacks {
    private final com.bumptech.glide4110.load.resource.bitmap.RecyclableBufferedInputStream bufferedStream;
    private final com.bumptech.glide4110.util.ExceptionCatchingInputStream exceptionStream;
