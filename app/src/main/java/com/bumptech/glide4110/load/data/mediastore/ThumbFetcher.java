...
import com.bumptech.glide4110.load.data.ExifOrientationStream;
...
public class ThumbFetcher implements DataFetcher<InputStream> {
  ...
  private final com.bumptech.glide4110.load.data.mediastore.ThumbnailStreamOpener opener;
  ...
  private static ThumbFetcher build(Context context, Uri uri, com.bumptech.glide4110.load.data.mediastore.ThumbnailQuery query) {
    ArrayPool byteArrayPool = Glide.get(context).getArrayPool();
    com.bumptech.glide4110.load.data.mediastore.ThumbnailStreamOpener opener =
        new com.bumptech.glide4110.load.data.mediastore.ThumbnailStreamOpener(
  ...
  @VisibleForTesting
  ThumbFetcher(Uri mediaStoreImageUri, com.bumptech.glide4110.load.data.mediastore.ThumbnailStreamOpener opener) {
  ...
  static class VideoThumbnailQuery implements com.bumptech.glide4110.load.data.mediastore.ThumbnailQuery {
  ...
  static class ImageThumbnailQuery implements com.bumptech.glide4110.load.data.mediastore.ThumbnailQuery {
