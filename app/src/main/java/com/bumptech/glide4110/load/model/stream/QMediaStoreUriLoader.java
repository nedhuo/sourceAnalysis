...
public final class QMediaStoreUriLoader<DataT> implements ModelLoader<Uri, DataT> {
  ...
  private static final class QMediaStoreUriFetcher<DataT> implements com.bumptech.glide4110.load.data.DataFetcher<DataT> {
    ...
    @Nullable private volatile com.bumptech.glide4110.load.data.DataFetcher<DataT> delegate;
    ...
    public void loadData(
      ...
      try {
        com.bumptech.glide4110.load.data.DataFetcher<DataT> local = buildDelegateFetcher();
        if (local == null) {
    ...
    @Nullable
    private com.bumptech.glide4110.load.data.DataFetcher<DataT> buildDelegateFetcher() throws FileNotFoundException {
    ...
    @Override
    public void cleanup() {
      com.bumptech.glide4110.load.data.DataFetcher<DataT> local = delegate;
      if (local != null) {
        local.cleanup();
      }
    }
