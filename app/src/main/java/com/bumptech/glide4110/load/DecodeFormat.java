 ...
 * android.graphics.Bitmap}s returned by {@link com.bumptech.glide4110.load.ResourceDecoder}s.
 *
 * <p>Note - In some cases it may not be possible to obey the requested setting, not all {@link
 * Downsampler}s support setting formats and certain images
...
public enum DecodeFormat {
   ...
   * use {@link RequestOptions#disallowHardwareConfig()}.
   *
