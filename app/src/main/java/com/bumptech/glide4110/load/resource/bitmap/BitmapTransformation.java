 ...
 * com.bumptech.glide4110.load.engine.Resource} objects for subclasses.
 *
...
public abstract class BitmapTransformation implements Transformation<Bitmap> {
  ...
  @NonNull
  @Override
  public final com.bumptech.glide4110.load.engine.Resource<Bitmap> transform(
          @NonNull Context context, @NonNull com.bumptech.glide4110.load.engine.Resource<Bitmap> resource, int outWidth, int outHeight) {
    ...
    com.bumptech.glide4110.load.engine.bitmap_recycle.BitmapPool bitmapPool = Glide.get(context).getBitmapPool();
    Bitmap toTransform = resource.get();
    int targetWidth = outWidth == com.bumptech.glide4110.request.target.Target.SIZE_ORIGINAL ? toTransform.getWidth() : outWidth;
    int targetHeight = outHeight == com.bumptech.glide4110.request.target.Target.SIZE_ORIGINAL ? toTransform.getHeight() : outHeight;
   ...
   *
   * @param pool A {@link com.bumptech.glide4110.load.engine.bitmap_recycle.BitmapPool} that can be used
