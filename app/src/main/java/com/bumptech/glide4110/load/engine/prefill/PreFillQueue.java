package com.bumptech.glide4110.load.engine.prefill;
...
final class PreFillQueue {
  ...
  private final Map<com.bumptech.glide4110.load.engine.prefill.PreFillType, Integer> bitmapsPerType;
  private final List<com.bumptech.glide4110.load.engine.prefill.PreFillType> keyList;
  private int bitmapsRemaining;
  private int keyIndex;

  public PreFillQueue(Map<com.bumptech.glide4110.load.engine.prefill.PreFillType, Integer> bitmapsPerType) {
  ...
  public com.bumptech.glide4110.load.engine.prefill.PreFillType remove() {
