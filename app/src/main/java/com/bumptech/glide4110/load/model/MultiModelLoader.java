...
class MultiModelLoader<Model, Data> implements ModelLoader<Model, Data> {
  ...
  public LoadData<Data> buildLoadData(
    ...
    List<com.bumptech.glide4110.load.data.DataFetcher<Data>> fetchers = new ArrayList<>(size);
  ...
  static class MultiFetcher<Data> implements com.bumptech.glide4110.load.data.DataFetcher<Data>, com.bumptech.glide4110.load.data.DataFetcher.DataCallback<Data> {

    private final List<com.bumptech.glide4110.load.data.DataFetcher<Data>> fetchers;
    ...
    MultiFetcher(
        @NonNull List<com.bumptech.glide4110.load.data.DataFetcher<Data>> fetchers,
        @NonNull Pool<List<Throwable>> throwableListPool) {
      this.throwableListPool = throwableListPool;
      com.bumptech.glide4110.util.Preconditions.checkNotEmpty(fetchers);
    ...
    public void cleanup() {
      ...
      exceptions = null;
      for (com.bumptech.glide4110.load.data.DataFetcher<Data> fetcher : fetchers) {
        fetcher.cleanup();
      }
    }
    ...
    public void onLoadFailed(@NonNull Exception e) {
      com.bumptech.glide4110.util.Preconditions.checkNotNull(exceptions).add(e);
      startNextOrFail();
    }
