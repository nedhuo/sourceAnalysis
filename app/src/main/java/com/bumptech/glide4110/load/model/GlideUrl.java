 ...
 *
 * <p>This class can also optionally wrap {@link com.bumptech.glide4110.load.model.Headers} for
 * convenience.
 */
public class GlideUrl implements Key {
  private static final String ALLOWED_URI_CHARS = "@#&=*+-_.,:!?()/~'%;$";
  private final com.bumptech.glide4110.load.model.Headers headers;
  ...
  public GlideUrl(URL url) {
    this(url, com.bumptech.glide4110.load.model.Headers.DEFAULT);
  }
  ...
  public GlideUrl(URL url, com.bumptech.glide4110.load.model.Headers headers) {
    this.url = com.bumptech.glide4110.util.Preconditions.checkNotNull(url);
    stringUrl = null;
    this.headers = com.bumptech.glide4110.util.Preconditions.checkNotNull(headers);
  }

  public GlideUrl(String url, Headers headers) {
    this.url = null;
    this.stringUrl = com.bumptech.glide4110.util.Preconditions.checkNotEmpty(url);
    this.headers = com.bumptech.glide4110.util.Preconditions.checkNotNull(headers);
  }
  ...
  private String getSafeStringUrl() {
    if (TextUtils.isEmpty(safeStringUrl)) {
      ...
      if (TextUtils.isEmpty(unsafeStringUrl)) {
        unsafeStringUrl = com.bumptech.glide4110.util.Preconditions.checkNotNull(url).toString();
      }
