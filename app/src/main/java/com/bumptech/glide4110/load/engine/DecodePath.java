...
public class DecodePath<DataType, ResourceType, Transcode> {
  ...
  public Resource<Transcode> decode(
      com.bumptech.glide4110.load.data.DataRewinder<DataType> rewinder,
      int width,
      int height,
  ...
  private Resource<ResourceType> decodeResource(
          com.bumptech.glide4110.load.data.DataRewinder<DataType> rewinder, int width, int height, @NonNull Options options)
      throws com.bumptech.glide4110.load.engine.GlideException {
