 ...
 *
 * @param <T> The type of {@link com.bumptech.glide4110.load.engine.Resource} that will be transformed.
 */
public class MultiTransformation<T> implements Transformation<T> {
  ...
  @NonNull
  @Override
  public com.bumptech.glide4110.load.engine.Resource<T> transform(
          @NonNull Context context, @NonNull com.bumptech.glide4110.load.engine.Resource<T> resource, int outWidth, int outHeight) {
    com.bumptech.glide4110.load.engine.Resource<T> previous = resource;
