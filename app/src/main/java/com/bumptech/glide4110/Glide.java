...
import com.bumptech.glide4110.load.engine.prefill.BitmapPreFiller;
import com.bumptech.glide4110.load.engine.prefill.PreFillType.Builder;
import com.bumptech.glide4110.load.model.AssetUriLoader;
import com.bumptech.glide4110.load.model.ByteArrayLoader;
import com.bumptech.glide4110.load.model.ByteBufferEncoder;
import com.bumptech.glide4110.load.model.ByteBufferFileLoader;
import com.bumptech.glide4110.load.model.DataUrlLoader;
import com.bumptech.glide4110.load.model.FileLoader;
import com.bumptech.glide4110.load.model.GlideUrl;
import com.bumptech.glide4110.load.model.MediaStoreFileLoader;
import com.bumptech.glide4110.load.model.ResourceLoader;
import com.bumptech.glide4110.load.model.StreamEncoder;
import com.bumptech.glide4110.load.model.StringLoader;
import com.bumptech.glide4110.load.model.UnitModelLoader;
import com.bumptech.glide4110.load.model.UriLoader;
import com.bumptech.glide4110.load.model.UrlUriLoader;
import com.bumptech.glide4110.load.model.stream.HttpUriLoader;
import com.bumptech.glide4110.load.model.stream.MediaStoreImageThumbLoader;
import com.bumptech.glide4110.load.model.stream.MediaStoreVideoThumbLoader;
import com.bumptech.glide4110.load.model.stream.QMediaStoreUriLoader;
import com.bumptech.glide4110.load.model.stream.UrlLoader;
import com.bumptech.glide4110.load.resource.bitmap.BitmapDrawableDecoder;
import com.bumptech.glide4110.load.resource.bitmap.BitmapDrawableEncoder;
import com.bumptech.glide4110.load.resource.bitmap.BitmapEncoder;
import com.bumptech.glide4110.load.resource.bitmap.ByteBufferBitmapDecoder;
import com.bumptech.glide4110.load.resource.bitmap.ByteBufferBitmapImageDecoderResourceDecoder;
import com.bumptech.glide4110.load.resource.bitmap.DefaultImageHeaderParser;
import com.bumptech.glide4110.load.resource.bitmap.Downsampler;
import com.bumptech.glide4110.load.resource.bitmap.ExifInterfaceImageHeaderParser;
import com.bumptech.glide4110.load.resource.bitmap.InputStreamBitmapImageDecoderResourceDecoder;
import com.bumptech.glide4110.load.resource.bitmap.ParcelFileDescriptorBitmapDecoder;
import com.bumptech.glide4110.load.resource.bitmap.ResourceBitmapDecoder;
import com.bumptech.glide4110.load.resource.bitmap.StreamBitmapDecoder;
import com.bumptech.glide4110.load.resource.bitmap.UnitBitmapDecoder;
import com.bumptech.glide4110.load.resource.bitmap.VideoDecoder;
import com.bumptech.glide4110.load.resource.bytes.ByteBufferRewinder;
import com.bumptech.glide4110.load.resource.drawable.ResourceDrawableDecoder;
import com.bumptech.glide4110.load.resource.drawable.UnitDrawableDecoder;
import com.bumptech.glide4110.load.resource.file.FileDecoder;
import com.bumptech.glide4110.load.resource.gif.ByteBufferGifDecoder;
import com.bumptech.glide4110.load.resource.gif.GifDrawable;
import com.bumptech.glide4110.load.resource.gif.GifDrawableEncoder;
import com.bumptech.glide4110.load.resource.gif.GifFrameResourceDecoder;
import com.bumptech.glide4110.load.resource.gif.StreamGifDecoder;
import com.bumptech.glide4110.load.resource.transcode.BitmapBytesTranscoder;
import com.bumptech.glide4110.load.resource.transcode.BitmapDrawableTranscoder;
import com.bumptech.glide4110.load.resource.transcode.DrawableBytesTranscoder;
import com.bumptech.glide4110.load.resource.transcode.GifDrawableBytesTranscoder;
...
import com.bumptech.glide4110.load.model.stream.HttpGlideUrlLoader;
...
import com.bumptech.glide4110.module.GlideModule;
import com.bumptech.glide4110.module.ManifestParser;
 ...
 * DiskCache} and {@link MemoryCache}.
 */
public class Glide implements ComponentCallbacks2 {
  ...
  private final com.bumptech.glide4110.GlideContext glideContext;
  ...
  public static Glide get(@NonNull Context context) {
    if (glide == null) {
      com.bumptech.glide4110.GeneratedAppGlideModule annotationGeneratedModule =
  ...
  private static void checkAndInitializeGlide(
      @NonNull Context context, @Nullable com.bumptech.glide4110.GeneratedAppGlideModule generatedAppGlideModule) {
  ...
  /**
   * @deprecated Use {@link #init(Context, com.bumptech.glide4110.GlideBuilder)} to get a singleton compatible with Glide's
   *     generated API.
  ...
  @VisibleForTesting
  public static void init(@NonNull Context context, @NonNull com.bumptech.glide4110.GlideBuilder builder) {
    com.bumptech.glide4110.GeneratedAppGlideModule annotationGeneratedModule = getAnnotationGeneratedGlideModules(context);
    synchronized (Glide.class) {
      if (Glide.glide != null) {
        tearDown();
      }
  ...
  private static void initializeGlide(
      @NonNull Context context, @Nullable com.bumptech.glide4110.GeneratedAppGlideModule generatedAppGlideModule) {
    initializeGlide(context, new com.bumptech.glide4110.GlideBuilder(), generatedAppGlideModule);
  }
  ...
  private static void initializeGlide(
      ...
      @NonNull com.bumptech.glide4110.GlideBuilder builder,
      @Nullable com.bumptech.glide4110.GeneratedAppGlideModule annotationGeneratedModule) {
    ...
    com.bumptech.glide4110.manager.RequestManagerRetriever.RequestManagerFactory factory =
  ...
  private static com.bumptech.glide4110.GeneratedAppGlideModule getAnnotationGeneratedGlideModules(Context context) {
    com.bumptech.glide4110.GeneratedAppGlideModule result = null;
    try {
      Class<com.bumptech.glide4110.GeneratedAppGlideModule> clazz =
          (Class<com.bumptech.glide4110.GeneratedAppGlideModule>)
  ...
  Glide(
      ...
      @NonNull com.bumptech.glide4110.manager.RequestManagerRetriever requestManagerRetriever,
      @NonNull com.bumptech.glide4110.manager.ConnectivityMonitorFactory connectivityMonitorFactory,
      int logLevel,
    ...
    registry = new com.bumptech.glide4110.Registry();
    ...
    registry
        ...
        /* Bitmaps */
        .append(com.bumptech.glide4110.Registry.BUCKET_BITMAP, ByteBuffer.class, Bitmap.class, byteBufferBitmapDecoder)
        .append(com.bumptech.glide4110.Registry.BUCKET_BITMAP, InputStream.class, Bitmap.class, streamBitmapDecoder);

    if (com.bumptech.glide4110.load.data.ParcelFileDescriptorRewinder.isSupported()) {
      registry.append(
          com.bumptech.glide4110.Registry.BUCKET_BITMAP,
    ...
    registry
        ...
        .append(com.bumptech.glide4110.Registry.BUCKET_BITMAP, Bitmap.class, Bitmap.class, new UnitBitmapDecoder())
        .append(Bitmap.class, bitmapEncoder)
        /* BitmapDrawables */
        .append(
            com.bumptech.glide4110.Registry.BUCKET_BITMAP_DRAWABLE,
            ByteBuffer.class,
        ...
        /* GIFs */
        .append(
            com.bumptech.glide4110.Registry.BUCKET_GIF,
            InputStream.class,
            GifDrawable.class,
            new StreamGifDecoder(imageHeaderParsers, byteBufferGifDecoder, arrayPool))
        .append(com.bumptech.glide4110.Registry.BUCKET_GIF, ByteBuffer.class, GifDrawable.class, byteBufferGifDecoder)
    ...
    com.bumptech.glide4110.request.target.ImageViewTargetFactory imageViewTargetFactory = new ImageViewTargetFactory();
    glideContext =
        new com.bumptech.glide4110.GlideContext(
            context,
            arrayPool,
            registry,
   ...
   * ResourceDecoder}s and {@link Transformation}s.
  ...
  /** Internal method. */
  @NonNull
  public com.bumptech.glide4110.manager.RequestManagerRetriever getRequestManagerRetriever() {
    return requestManagerRetriever;
  }

  /**
   * Adjusts Glide's current and maximum memory usage based on the given {@link com.bumptech.glide4110.MemoryCategory}.
   *
   * <p>The default {@link com.bumptech.glide4110.MemoryCategory} is {@link com.bumptech.glide4110.MemoryCategory#NORMAL}. {@link
   * com.bumptech.glide4110.MemoryCategory#HIGH} increases Glide's maximum memory usage by up to 50% and {@link
   * com.bumptech.glide4110.MemoryCategory#LOW} decreases Glide's maximum memory usage by 50%. This method should be used
  ...
  @NonNull
  public com.bumptech.glide4110.MemoryCategory setMemoryCategory(@NonNull com.bumptech.glide4110.MemoryCategory memoryCategory) {
    // Engine asserts this anyway when removing resources, fail faster and consistently
    Util.assertMainThread();
    // memory cache needs to be trimmed before bitmap pool to trim re-pooled Bitmaps too. See #687.
  ...
  /** Creates a new instance of {@link com.bumptech.glide4110.request.RequestOptions}. */
  public interface RequestOptionsFactory {

    /** Returns a non-null {@link com.bumptech.glide4110.request.RequestOptions} object. */
    @NonNull
