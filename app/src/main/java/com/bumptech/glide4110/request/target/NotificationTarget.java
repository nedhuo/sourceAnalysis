...
public class NotificationTarget extends CustomTarget<Bitmap> {
  ...
  public NotificationTarget(
      ...
      String notificationTag) {
    super(width, height);
    this.context = com.bumptech.glide4110.util.Preconditions.checkNotNull(context, "Context must not be null!");
    this.notification =
        com.bumptech.glide4110.util.Preconditions.checkNotNull(notification, "Notification object can not be null!");
    this.remoteViews =
