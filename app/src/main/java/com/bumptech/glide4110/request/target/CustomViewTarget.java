...
public abstract class CustomViewTarget<T extends View, Z> implements Target<Z> {
   ...
   */
  @Override
  public final void getSize(@NonNull com.bumptech.glide4110.request.target.SizeReadyCallback cb) {
    sizeDeterminer.getSize(cb);
  }

  @Override
  public final void removeCallback(@NonNull com.bumptech.glide4110.request.target.SizeReadyCallback cb) {
