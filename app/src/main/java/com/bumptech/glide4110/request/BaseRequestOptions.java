...
import com.bumptech.glide4110.RequestBuilder;
...
import com.bumptech.glide4110.load.MultiTransformation;
...
import com.bumptech.glide4110.load.engine.DiskCacheStrategy;
...
import com.bumptech.glide4110.load.resource.bitmap.CenterCrop;
import com.bumptech.glide4110.load.resource.bitmap.CenterInside;
import com.bumptech.glide4110.load.resource.bitmap.CircleCrop;
import com.bumptech.glide4110.load.resource.bitmap.DownsampleStrategy;
import com.bumptech.glide4110.load.resource.bitmap.Downsampler;
import com.bumptech.glide4110.load.resource.bitmap.DrawableTransformation;
import com.bumptech.glide4110.load.resource.bitmap.FitCenter;
...
import com.bumptech.glide4110.load.resource.gif.GifDrawableTransformation;
import com.bumptech.glide4110.load.resource.gif.GifOptions;
import com.bumptech.glide4110.signature.EmptySignature;
...
import com.bumptech.glide4110.util.CachedHashCodeArrayMap;
...
public abstract class BaseRequestOptions<T extends BaseRequestOptions<T>> implements Cloneable {
  ...
  @NonNull
  private Map<Class<?>, Transformation<?>> transformations = new com.bumptech.glide4110.util.CachedHashCodeArrayMap<>();
   ...
   *     Target}'s dimensions when loading the resource.
  ...
  public T diskCacheStrategy(@NonNull DiskCacheStrategy strategy) {
    ...
    this.diskCacheStrategy = com.bumptech.glide4110.util.Preconditions.checkNotNull(strategy);
  ...
  public T priority(@NonNull Priority priority) {
    ...
    this.priority = com.bumptech.glide4110.util.Preconditions.checkNotNull(priority);
    fields |= PRIORITY;
  ...
  public T signature(@NonNull Key signature) {
    ...
    this.signature = com.bumptech.glide4110.util.Preconditions.checkNotNull(signature);
    fields |= SIGNATURE;
    return selfOrThrowIfLocked();
  }
  ...
  public <Y> T set(@NonNull Option<Y> option, @NonNull Y value) {
    ...
    com.bumptech.glide4110.util.Preconditions.checkNotNull(option);
    com.bumptech.glide4110.util.Preconditions.checkNotNull(value);
  ...
  public T decode(@NonNull Class<?> resourceClass) {
    ...
    this.resourceClass = com.bumptech.glide4110.util.Preconditions.checkNotNull(resourceClass);
  ...
  public T encodeFormat(@NonNull Bitmap.CompressFormat format) {
    return set(BitmapEncoder.COMPRESSION_FORMAT, com.bumptech.glide4110.util.Preconditions.checkNotNull(format));
  }
  ...
  public T format(@NonNull DecodeFormat format) {
    com.bumptech.glide4110.util.Preconditions.checkNotNull(format);
  ...
  public T downsample(@NonNull DownsampleStrategy strategy) {
    return set(DownsampleStrategy.OPTION, com.bumptech.glide4110.util.Preconditions.checkNotNull(strategy));
  }
  ...
  <Y> T transform(
    ...
    com.bumptech.glide4110.util.Preconditions.checkNotNull(resourceClass);
