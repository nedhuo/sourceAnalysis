package com.bumptech.glide4110.request.target;
...
public abstract class ViewTarget<T extends View, Z> extends BaseTarget<Z> {
  ...
  public ViewTarget(@NonNull T view) {
    this.view = com.bumptech.glide4110.util.Preconditions.checkNotNull(view);
  ...
  @CallSuper
  @Override
  public void getSize(@NonNull com.bumptech.glide4110.request.target.SizeReadyCallback cb) {
    sizeDeterminer.getSize(cb);
  }

  @CallSuper
  @Override
  public void removeCallback(@NonNull com.bumptech.glide4110.request.target.SizeReadyCallback cb) {
   ...
   * versions, be sure to call {@link RequestManager#clear(View)} on any view you
  ...
  static final class SizeDeterminer {
    ...
    private final List<com.bumptech.glide4110.request.target.SizeReadyCallback> cbs = new ArrayList<>();
    @com.bumptech.glide4110.util.Synthetic
    ...
    private void notifyCbs(int width, int height) {
      ...
      for (com.bumptech.glide4110.request.target.SizeReadyCallback cb : new ArrayList<>(cbs)) {
    ...
    void getSize(@NonNull com.bumptech.glide4110.request.target.SizeReadyCallback cb) {
      int currentWidth = getTargetWidth();
      int currentHeight = getTargetHeight();
      if (isViewStateAndSizeValid(currentWidth, currentHeight)) {
    ...
    /**
     * The callback may be called anyway if it is removed by another {@link com.bumptech.glide4110.request.target.SizeReadyCallback} or
