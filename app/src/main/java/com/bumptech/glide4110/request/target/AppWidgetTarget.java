...
public class AppWidgetTarget extends CustomTarget<Bitmap> {
  ...
  public AppWidgetTarget(
    ...
    this.context = com.bumptech.glide4110.util.Preconditions.checkNotNull(context, "Context can not be null!");
    this.remoteViews =
        com.bumptech.glide4110.util.Preconditions.checkNotNull(remoteViews, "RemoteViews object can not be null!");
    this.widgetIds = com.bumptech.glide4110.util.Preconditions.checkNotNull(widgetIds, "WidgetIds can not be null!");
    this.viewId = viewId;
    componentName = null;
  }
