...
import com.bumptech.glide4110.load.resource.drawable.DrawableDecoderCompat;
...
import com.bumptech.glide4110.request.target.SizeReadyCallback;
 ...
 * {@link com.bumptech.glide4110.request.target.Target}.
 *
...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback {
    ...
    private final com.bumptech.glide4110.request.RequestCoordinator requestCoordinator;
    ...
    private final com.bumptech.glide4110.request.BaseRequestOptions<?> requestOptions;
    ...
    private final com.bumptech.glide4110.request.target.Target<R> target;

    @Nullable
    private final List<RequestListener<R>> requestListeners;

    private final com.bumptech.glide4110.request.transition.TransitionFactory<? super R> animationFactory;
    ...
    public static <R> SingleRequest<R> obtain(
            ...
            int overrideHeight,
            Priority priority,
            com.bumptech.glide4110.request.target.Target<R> target,
            RequestListener<R> targetListener,
            @Nullable List<RequestListener<R>> requestListeners,
            com.bumptech.glide4110.request.RequestCoordinator requestCoordinator,
            Engine engine,
            com.bumptech.glide4110.request.transition.TransitionFactory<? super R> animationFactory,
    ...
    /**
     * 通过DecodeJob的 callCallbackOnResourceReady方法回调回来
     * A callback method that should never be invoked directly.
     */
    ...
    private void onResourceReady(Resource<R> resource, R result, DataSource dataSource) {
        ...
        try {
            ...
            if (!anyListenerHandledUpdatingTarget) {
                ...
                //1. 最终回归ImageViewTarget 后面简单 就不再看了
    ...
    public boolean isEquivalentTo(Request o) {
        ...
        com.bumptech.glide4110.request.BaseRequestOptions<?> localRequestOptions;
