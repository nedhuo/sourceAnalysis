...
import com.bumptech.glide4110.request.ErrorRequestCoordinator;
import com.bumptech.glide4110.request.FutureTarget;
import com.bumptech.glide4110.request.Request;
import com.bumptech.glide4110.request.RequestCoordinator;
import com.bumptech.glide4110.request.RequestFutureTarget;
import com.bumptech.glide4110.request.RequestListener;
import com.bumptech.glide4110.request.SingleRequest;
import com.bumptech.glide4110.request.ThumbnailRequestCoordinator;
import com.bumptech.glide4110.request.target.PreloadTarget;
import com.bumptech.glide4110.request.target.Target;
import com.bumptech.glide4110.request.target.ViewTarget;
import com.bumptech.glide4110.signature.AndroidResourceSignature;
...
public class RequestBuilder<TranscodeType> extends BaseRequestOptions<RequestBuilder<TranscodeType>>
  ...
  private com.bumptech.glide4110.TransitionOptions<?, ? super TranscodeType> transitionOptions;
  ...
  /**
   * Sets the {@link com.bumptech.glide4110.TransitionOptions} to use to transition from the placeholder or thumbnail when
   * this load completes.
   *
   * <p>The given {@link com.bumptech.glide4110.TransitionOptions} will replace any {@link com.bumptech.glide4110.TransitionOptions} set
   * previously.
   *
   * @return This request builder.
   */
   ...
   * by default, consider registering a custom {@link ModelLoader} or
   ...
   * ModelLoader} or {@link ResourceDecoder}
   ...
   * ModelLoaderFactory} currently registered or {@link Integer} to
   * load the image represented by the given {@link Integer} resource id. Defaults to {@link
   * ResourceLoader} to load resource id models.
   *
   ...
   *
   * @see #load(Integer)
   * @see com.bumptech.glide4110.signature.AndroidResourceSignature
   */
  @NonNull
  @CheckResult
  @Override
  ...
  private Request buildThumbnailRequestRecursive(
    ...
    if (thumbnailBuilder != null) {
      ...
      com.bumptech.glide4110.TransitionOptions<?, ? super TranscodeType> thumbTransitionOptions =
