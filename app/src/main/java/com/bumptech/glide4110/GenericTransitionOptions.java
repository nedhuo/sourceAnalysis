...
/**
 * Implementation of {@link com.bumptech.glide4110.TransitionOptions} that exposes only generic methods that can be applied
...
public final class GenericTransitionOptions<TranscodeType>
   ...
   *
   * @see GenericTransitionOptions#transition(com.bumptech.glide4110.request.transition.ViewPropertyTransition.Animator)
   */
  @NonNull
   ...
   *
   * @see GenericTransitionOptions#transition(com.bumptech.glide4110.request.transition.TransitionFactory)
   */
  @NonNull
  public static <TranscodeType> GenericTransitionOptions<TranscodeType> with(
