...
import com.bumptech.glide4110.request.transition.NoTransition;
...
import com.bumptech.glide4110.request.transition.ViewAnimationFactory;
import com.bumptech.glide4110.request.transition.ViewPropertyAnimationFactory;
import com.bumptech.glide4110.request.transition.ViewPropertyTransition;
...
public abstract class TransitionOptions<
  ...
  private com.bumptech.glide4110.request.transition.TransitionFactory<? super TranscodeType> transitionFactory = com.bumptech.glide4110.request.transition.NoTransition.getFactory();
   ...
   *
   * @param animator The {@link com.bumptech.glide4110.request.transition.ViewPropertyTransition
   *     .Animator} to run.
   * @return This request builder.
   */
  @NonNull
  ...
  /**
   * Uses the given {@link com.bumptech.glide4110.request.transition.TransitionFactory} to build a {@link
   * Transition} for each request started with these {@code
   * TransitionOptions}.
   *
   * @return This request builder.
   */
  ...
  public final CHILD transition(
      @NonNull com.bumptech.glide4110.request.transition.TransitionFactory<? super TranscodeType> transitionFactory) {
